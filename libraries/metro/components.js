...
prx.types.metro_icon = {
	...
	,onDisplay: function(item,containerid,symbol) {
		...
		cR += '<div class="metro-icon liveUpdate-backgroundColor liveUpdate-borderColor changeProperty-backgroundColor changeProperty-borderWidth changeProperty-borderColor">';
...
prx.types.metro_badge = {
	...
	,onDisplay: function(item,containerid,symbol) {
		...
		cR += '<style>';
		cR += prx.items.getComponentBaseStyle(item, containerid, symbol);
		cR += '#'+_id+' .metro-badge-inner { '+prx.gradients.getBgCssByProperty(item.backgroundColor,'color-background')+'; '+prx.componentsHelper.getProp(item.textFont,'font-family')+' color: '+prx.componentsHelper.getProp(item.textColor,'color-text')+'; font-size: '+prx.componentsHelper.getProp(item.textSize,'num-text-size')+'px; }'
		...
		cR += '<div class="metro-badge-inner liveUpdate-backgroundColor liveUpdate-textColor changeProperty-backgroundColor changeProperty-textFont changeProperty-textColor changeProperty-textSize">'
        if(prx.componentsHelper.getProp(item.badgeType,'other') == 'glyph') {
...
prx.types.metro_appbar = {
	...
	,onDisplay: function(item,containerid,symbol) {
		...
		cR += '<style>';
		cR += prx.items.getComponentBaseStyle(item, containerid, symbol);
		cR += '#'+_id+' .metro-appbar-inner { '+prx.gradients.getBgCssByProperty(item.backgroundColor,'color-background')+'; '+prx.componentsHelper.getProp(item.textFont,'font-family')+' '+_props+' color: '+prx.componentsHelper.getProp(item.textColor,'color-text')+'; font-size: '+prx.componentsHelper.getProp(item.textSize,'num-text-size')+'px; }';
...
prx.types.metro_charms = {
	...
	,onDisplay: function(item,containerid,symbol) {
		...
		cR += '<style>';
		cR += prx.items.getComponentBaseStyle(item, containerid, symbol);
		cR += '#'+_id+' .metro-charms-outer { '+prx.gradients.getBgCssByProperty(item.backgroundColor,'color-background')+'; '+prx.componentsHelper.getProp(item.textFont,'font-family')+' '+_props+' color: '+prx.componentsHelper.getProp(item.textColor,'color-text')+'; font-size: '+prx.componentsHelper.getProp(item.textSize,'num-text-size')+'px; }';
		cR += '</style>';
		cR += prx.items.getComponentPrependDivs(item, containerid, symbol);
...
prx.types.metro_contextmenu = {
	...
	,onDisplay: function(item,containerid,symbol) {
		...
		cR += '<style>';
		cR += prx.items.getComponentBaseStyle(item, containerid, symbol);
		cR += '#'+_id+' { border: '+prx.componentsHelper.getProp(item.borderWidth,'num-border-width')+'px solid '+prx.componentsHelper.getProp(item.borderColor,'color-border')+'; '+prx.gradients.getBgCssByProperty(item.backgroundColor,'color-background')+'; '+prx.componentsHelper.getProp(item.textFont,'font-family')+' '+_props+' color: '+prx.componentsHelper.getProp(item.textColor,'color-text')+'; font-size: '+prx.componentsHelper.getProp(item.textSize,'num-text-size')+'px; text-align: '+prx.componentsHelper.getProp(item.textAlign,'align')+'; }';
		cR += '</style>';
		cR += prx.items.getComponentPrependDivs(item, containerid, symbol);
...
prx.types.metro_dialog = {
	...
	,onDisplay: function(item,containerid,symbol) {
		...
		cR += '<style>';
		cR += prx.items.getComponentBaseStyle(item, containerid, symbol);
		cR += '#'+_id+' { '+prx.gradients.getBgCssByProperty(item.backgroundColor,'color-background')+';  '+prx.componentsHelper.getProp(item.textFont,'font-family')+' '+_props+' color: '+prx.componentsHelper.getProp(item.textColor,'color-text')+'; font-size: '+prx.componentsHelper.getProp(item.textSize,'num-text-size')+'px; text-align: '+prx.componentsHelper.getProp(item.textAlign,'align')+'; }';
		...
		cR += '<div class="type-metro-dialog-inner liveUpdate-buttonBorderColor liveUpdate-buttonBorderWidth changeProperty-buttonBorderColor changeProperty-buttonBorderWidth">';
		...
		$.each(item.buttons, function(i,elm){
			cButtons += '<div class="metro-dialog-button dynamic-property liveUpdate-buttonBackgroundColor liveUpdate-buttonBorderColor liveUpdate-buttonBorderWidth liveUpdate-buttonTextColor changeProperty-buttonBorderColor changeProperty-buttonBorderWidth " id="'+_id+'-buttons-'+i+'" data-dynamic-property-index="'+i+'">';
				...
				[
					...
					,{
						...
						,changeProperty: {
							...
							property: 'border-color',
							selector: '.type-metro-dialog-inner,.metro-dialog-button', // GS - the same property also changes the component border!
							transitionable: true
						}
					}
				]
...
prx.types.metro_toast_mini = {
	...
	,onDisplay: function(item,containerid,symbol) {
		...
		cR += '<style>';
		cR += prx.items.getComponentBaseStyle(item, containerid, symbol);
		cR += '#'+_id+' .metro-toast-mini-inner { line-height: '+_dims.height+'px; '+prx.gradients.getBgCssByProperty(item.backgroundColor,'color-background')+';  '+prx.componentsHelper.getProp(item.textFont,'font-family')+' color: '+prx.componentsHelper.getProp(item.textColor,'color-text')+'; font-size: '+prx.componentsHelper.getProp(item.textSize,'num-text-size')+'px;  }';
		cR += '</style>';
		cR += prx.items.getComponentPrependDivs(item, containerid, symbol);
...
prx.types.metro_toast = {
	...
	,onDisplay: function(item,containerid,symbol) {
		...
		cR += '<style>';
		cR += prx.items.getComponentBaseStyle(item, containerid, symbol);
		cR += '#'+_id+' .metro-toast-inner { '+prx.gradients.getBgCssByProperty(item.backgroundColor,'color-background')+';  '+prx.componentsHelper.getProp(item.textFont,'font-family')+' color: '+prx.componentsHelper.getProp(item.textColor,'color-text')+'; font-size: '+prx.componentsHelper.getProp(item.textSize,'num-text-size')+'px;  }';
		if(prx.componentsHelper.getProp(item.imgSrc.fileId,'other') != '') {
...
prx.types.metro_tile_plain = {
	...
	,onDisplay: function(item,containerid,symbol) {
		...
		cR += '<style>';
		cR += prx.items.getComponentBaseStyle(item, containerid, symbol);
		cR += '#'+_id+' { '+prx.gradients.getBgCssByProperty(item.backgroundColor,'color-background')+'; }';
		cR += '</style>';
		cR += prx.items.getComponentPrependDivs(item, containerid, symbol);
		cR += prx.items.getComponentAppendDivs(item, containerid, symbol);
		cR += '</div>';
...
prx.types.metro_tile_icon = {
	...
	,onDisplay: function(item,containerid,symbol) {
		...
		cR += '<style>';
		cR += prx.items.getComponentBaseStyle(item, containerid, symbol);
		cR += '#'+_id+' .metro-tile-icon-inner { '+prx.utils.getBgCss(item.backgroundColor)+';  '+prx.componentsHelper.getProp(item.textFont,'font-family')+' color: '+prx.componentsHelper.getProp(item.textColor,'color-text')+'; font-size: '+prx.componentsHelper.getProp(item.textSize,'num-text-size')+'px;  }';
		if(prx.componentsHelper.getProp(item.imgSrc.fileId,'other') != '') {
		...
		cR += '<div class="metro-tile-icon-inner liveUpdate-backgroundColor changeProperty-backgroundColor liveUpdate-textColor">';
...
prx.types.metro_tile_text = {
	...
	,onDisplay: function(item,containerid,symbol) {
		...
		cR += '<style>';
		cR += prx.items.getComponentBaseStyle(item, containerid, symbol);
		cR += '#'+_id+' .metro-tile-text-inner { '+prx.gradients.getBgCssByProperty(item.backgroundColor,'color-background')+';  '+prx.componentsHelper.getFontCssFromFontFamily(item.textFont)+' color: '+prx.componentsHelper.getProp(item.textColor,'color-text')+'; font-size: '+item.textSize+'px;  }';
		if(prx.componentsHelper.getProp(item.imgSrc.fileId,'other') != '') {
