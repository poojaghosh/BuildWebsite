...
prx.types.ios7_segmentedcontrol = {
	...
	,onDisplay: function(item,containerid,symbol) {
		...
		$.each(item.buttons, function(i,elm) {
			...
			cR += '<label for="'+_id+'-radio-'+i+'" '+((prx.componentsHelper.getProp(item.selected,'num-other') == i) ? 'class="liveUpdate-activeBackgroundColor liveUpdate-activeTextColor changeProperty-activeBackgroundColor changeProperty-activeTextColor"' : '')+' >'
...
prx.types.ios7_actionsheet = {
	...
	,onDisplay: function(item,containerid,symbol) {
		...
		cR += '<div class="ios7-actionsheet-buttons liveUpdate-backgroundColor liveUpdate-textColor liveUpdate-borderColor changeProperty-backgroundColor changeProperty-borderColor changeProperty-borderRadius changeProperty-borderWidth changeProperty-textSize changeProperty-textFont">'
		$.each(item.buttons, function(i,elm) {
